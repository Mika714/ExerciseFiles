...
import com.sajworks.listmaker.adapters.MainAdapter
import com.sajworks.listmaker.dataobjects.ListMakerApplication
import com.sajworks.listmaker.dataobjects.ListNamesDO
import com.sajworks.listmaker.utilities.AWSProvider
import com.sajworks.listmaker.utilities.ListManager
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        ...
        if (item.itemId == R.id.menu_main_signout) {
